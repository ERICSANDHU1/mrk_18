...
export const metadata: Metadata = {
  title: { template: "%s — MRK18", default: "mrk — MRK18" },
  robots: { index: false, follow: false },
};

/** mrk shell — same rail + theme as the rest of the app. */
export default function MrkLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
