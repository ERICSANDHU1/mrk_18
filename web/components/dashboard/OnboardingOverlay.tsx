    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <span aria-hidden className="mb-5 grid h-10 w-10 place-items-center rounded-xl bg-molten text-base font-extrabold text-white">
              m
            </span>
            ...
            <button
              ...
              className={`mt-7 w-full rounded-lg px-4 py-2.5 text-[13px] font-bold transition-all duration-300 ${
                ready
                  ? "bg-molten text-white hover:opacity-90"
