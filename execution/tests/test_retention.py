...
async def test_erase_removes_all_personal_data(factory):
    ...
    # everything present
    for model in (FounderRow, FounderProfileRow, RunRow, ContentItemRow, ApprovalEventRow, PublishResultRow, ConnectedAccountRow, AuditRow):
    ...
    for model in (FounderRow, FounderProfileRow, RunRow, ContentItemRow, ApprovalEventRow, PublishResultRow, ConnectedAccountRow):
